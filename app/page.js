  ...
  return (
    <main className="hero">
      ...
      <div className="velvetScene" aria-hidden="true">
        ...
        <div className="warpTunnel">
          <span className="tunnelRing r1" />
          <span className="tunnelRing r2" />
          <span className="tunnelRing r3" />
          <span className="tunnelRing r4" />
          <span className="tunnelStreak s1" />
          <span className="tunnelStreak s2" />
          <span className="tunnelStreak s3" />
          <span className="tunnelStreak s4" />
          <span className="tunnelStreak s5" />
          <span className="tunnelStreak s6" />
        </div>
      </div>
