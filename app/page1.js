  ...
  return (
    <main className="hero">
      ...
      <div className="velvetScene" aria-hidden="true">
        ...
        <div className="warpCore">
          <span className="warpParticle p1" />
          <span className="warpParticle p2" />
          <span className="warpParticle p3" />
          <span className="warpParticle p4" />
          <span className="warpParticle p5" />
          <span className="warpParticle p6" />
          <span className="warpParticle p7" />
          <span className="warpParticle p8" />
        </div>
      </div>
